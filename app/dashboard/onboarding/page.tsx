...
const STEPS = [
  ...
  { Icon: ImageIcon, t: "Add photos", s: "A cover photo + 5 gallery shots", done: true, href: "/dashboard/listing" },
  { Icon: Clock, t: "Set your opening hours", s: "So people know when to visit", done: true, href: "/dashboard/listing" },
      ...
      <div className="mx-auto max-w-[720px]">
        ...
        <ManCard style={{ padding: 22, marginTop: 22 }}>
          ...
          <div className="mt-4 grid gap-2">
            {STEPS.map((s) => (
              <Link key={s.t} href={s.href} className="flex items-center gap-3.5 rounded-[12px] p-3.5" style={{ border: "1px solid var(--card-edge)", background: s.done ? "var(--paper-2)" : "var(--card)" }}>
