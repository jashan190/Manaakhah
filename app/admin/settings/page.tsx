...
export default function AdminSettingsPage() {
  ...
  return (
    <AdminShell active="settings">
      ...
      <div className="mb-6">
        <h1 className="t-h2" style={{ color: "var(--ink-900)" }}>System Settings</h1>
        <p className="t-body-sm" style={{ color: "var(--ink-500)" }}>Configure platform settings and preferences</p>
      </div>
